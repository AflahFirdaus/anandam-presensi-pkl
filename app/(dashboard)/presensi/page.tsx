...
export default function PresensiPage() {
  ...
  async function handlePresensi(type: "in" | "out") {
    ...
    try {
      ...
      const successMsg =
        type === "in"
          ? `Presensi masuk berhasil (${data.via === "KANTOR" ? "Di Kantor" : "Di Luar Kantor"}).`
          : `Presensi pulang berhasil (${data.via === "KANTOR" ? "Di Kantor" : "Di Luar Kantor"}).`;
